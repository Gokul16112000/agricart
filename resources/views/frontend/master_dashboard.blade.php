...
@include('frontend.body.footer')
    ...
    <script src="{{asset('frontend/assets/js/vendor/bootstrap.bundle.min.j')}}s"></script>
...
<script type="text/javascript">
    ...
    <td class="row_img"><img src="/${value.product.product_thambnail} " style="width:300px; height:300px;"  alt="compare-img" /></td>
            ...
            <tr class="pr_remove text-muted">
                ...
                <td class="row_remove">
                <a type="submit" class="text-muted"  id="${value.id}" onclick="compareRemove(this.id)"><i class="fi-rs-trash mr-5"></i>
                <span>Remove</span> </a>
                </td>
