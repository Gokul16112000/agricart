										...
										@endif
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input class="form-control @error('current_password') is-invalid @enderror" name="current_password" type="password"  id="current_password" placeholder="Current Password" />
